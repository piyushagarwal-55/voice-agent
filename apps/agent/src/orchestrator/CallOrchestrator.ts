...
import { SalonCatalogService } from "../services/SalonCatalogService.js";
...
export class CallOrchestrator {
  ...
  readonly salonCatalogService = new SalonCatalogService();
  ...
  constructor(params: { callId: string; roomName: string }) {
    ...
    this.tools = new ToolRegistry({
      ...
      salonCatalogService: this.salonCatalogService,
